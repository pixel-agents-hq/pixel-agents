...
48 tests total. Generated by `scripts/generate-e2e-inventory.mjs`. Re-run after adding or removing tests.

### `@area:spawn` (3 tests)

- `e2e/agent-spawn.spec.ts:21` — clicking + Agent spawns mock claude and creates a JSONL session file
