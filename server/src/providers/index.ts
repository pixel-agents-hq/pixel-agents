...
import { vscodeCopilotProvider } from './hook/vscode-copilot/copilot.js';

export { claudeProvider, vscodeCopilotProvider };
...
/** Providers that can feed the shared runtime. OTel providers do not install hooks. */
export const agentProviders: readonly HookProvider[] = [claudeProvider, vscodeCopilotProvider];
